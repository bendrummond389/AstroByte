...
const BabeCard: React.FC<BabeCardProps> = ({ children, image, imageAlignment }) => (
  <div className="aspect-1 relative mt-4 h-96 w-full rounded-lg border-2 border-blue-100  lg:mx-4 lg:h-screen lg:w-1/3">
    <Image
...
const PricesSection = () => (
  <div className="relative h-fit w-full md:h-screen">
    <div className="flex flex-col p-6 lg:flex-row ">
        ...
        <div className="flex h-full flex-col justify-between">
          <div className="relative flex h-32 w-32 items-start md:h-56 md:w-56">
            ...
            <div className="relative z-10 flex h-full w-full flex-col items-center justify-center align-baseline">
              <div className={`text-black md:text-xl ${bebasNeue.className}`}>Starting at</div>
              <div className={`text-custom-200 md:text-xl ${bakbakOne.className}`}>$1200</div>
            </div>
          </div>
          {/* cigarettes */}
          <div className="mb-10 flex-col px-3">
            <div className="flex h-12 w-full flex-row items-center rounded-xl border-2 border-black">
              ...
              >
                <div className="flex h-full items-center">$1500 Min. Upfront Cost</div>{' '}
              </div>
            ...
            <div className="my-3 flex h-12 w-full flex-row items-center rounded-xl border-2 border-black">
              <div
                className={`h-full w-5/6 rounded-l-lg bg-slate-200 pl-3 text-black ${b612Mono.className}`}
              >
                <div className="flex h-full items-center">Custom Design</div>{' '}
              </div>
              <div className="bg-custom-200 h-full w-1/5 rounded-r-lg border-l border-black"></div>
            </div>
            <div className="flex h-12 w-full flex-row items-center rounded-xl border-2 border-black">
              <div
                className={`h-full w-5/6 rounded-l-lg bg-slate-200 pl-3 text-black ${b612Mono.className}`}
              >
                <div className="flex h-full items-center">Hosting Included</div>{' '}
              </div>
              <div className="bg-custom-200 h-full w-1/5 rounded-r-lg border-l border-black"></div>
            </div>
          </div>
      ...
      <BabeCard image="/PinkBabe.webp" imageAlignment="object-left-top">
        ...
        <div className="flex h-full flex-col justify-center">
          <div className="relative ml-5 flex h-32 w-32 items-start md:h-56 md:w-56">
            ...
            />
            <div className="relative z-10 flex h-full w-full flex-col items-center justify-center align-baseline">
              <div className={`text-black md:text-xl ${bakbakOne.className}`}>$200/Month</div>
            </div>
          </div>
        </div>
      </BabeCard>
      <BabeCard image="/BlueBabe.webp" imageAlignment="object-right-top">
        <div className="flex h-full w-full flex-col justify-end">
          {/* Star */}
          <div className="relative ml-5 flex h-48 w-48 items-end md:h-64 md:w-64">
            <Image
              alt="star to add empahsis"
            ...
            />
            <div className="relative z-10 flex h-full w-full flex-col items-center justify-center align-baseline">
              <div className={`text-black md:text-xl ${bebasNeue.className}`}>Includes</div>
              <div className={`text-custom-200 md:text-xl ${bakbakOne.className}`}>Logo Design</div>
            </div>
          </div>
        </div>
      </BabeCard>
