    ...
    <main className="flex h-screen w-full">
      ...
      <div className="relative h-full w-full">
        ...
        <div className="flex h-full flex-col justify-between p-5">
          <Navbar />
          <div className="border-text-200 bg-background-950 z-10 mb-10 h-fit w-full rounded-4xl border-2 bg-opacity-80 p-8 drop-shadow-2xl md:w-1/2">
            <div className={sourceSans.className}>
              ...
              <div className="text-center">
                <div className="text-text-200 border-text-200 bg-background-950 hover:bg-background-900 mx-auto w-fit rounded-full border-2 p-5 text-xl">
                  Ready For Launch
                </div>
              </div>
            </div>
